...
function OrderHistory() {
  ...
  const fetchOrders = async () => {
    try {
      ...
      setError(error.message || "Unable to load your order history");
    } finally {
      setLoading(false);
    }
  };
    ...
    return (
      <div className="min-h-[70vh] bg-orange-50 px-6 py-16">
        <div className="max-w-3xl mx-auto bg-white rounded-3xl p-8 text-center shadow-sm">
          <XCircle size={50} className="mx-auto mb-4 text-red-500" />
        ...
        {orders.length === 0 ? (
          ...
          <div className="space-y-6">
            {orders.map((order) => {
              ...
              /*
                Delivery has already been confirmed when
                deliveryConfirmed is true.

                After confirmation:
                - Track Your Order disappears
                - Delivery Confirmation disappears
                - Status indicator remains
              */
              const deliveryAlreadyConfirmed = order.deliveryConfirmed === true;
                  ...
                  <div className="p-5 sm:p-6 bg-gray-50 border-t border-gray-100">
                    {deliveryAlreadyConfirmed ? (
                      /*
                        ...
                        The customer already answered the
                      ...
                      */
                      ...
                      /*
                        ...
                        Both buttons remain visible until
