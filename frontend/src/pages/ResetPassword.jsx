...
function ResetPassword() {
  ...
  // email + resetToken passed from VerifyOTP page
  const email = location.state?.email;
  const resetToken = location.state?.resetToken;

  // If missing state, redirect back to start
  useEffect(() => {
    if (!email || !resetToken) {
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-linear-to-r from-yellow-600 to-orange-600 px-8 py-6 text-center">
            ...
            <p className="text-orange-100 text-sm mt-1">Set New Password</p>
          </div>
            ...
            {success ? (
              ...
              <div className="text-center py-4">
                ...
                <div className="w-full bg-gray-100 rounded-full h-1.5 overflow-hidden">
                  <div className="bg-orange-500 h-1.5 rounded-full animate-pulse w-full" />
                </div>
              </div>
            ) : (
              // ── Form state ───────────────────────────────────────────────
              <>
                <div className="mb-6">
                  ...
                  <p className="text-gray-500 text-sm mt-2">
                    Choose a strong password for your Kings Chops account.
                  </p>
                </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className={`w-full pl-10 pr-12 py-3 rounded-xl border focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-all text-sm ${
