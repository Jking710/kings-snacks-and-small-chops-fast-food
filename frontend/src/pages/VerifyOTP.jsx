      ...
      <div className="relative w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          ...
          <div className="bg-linear-to-r from-yellow-600 to-orange-600 px-8 py-6 text-center">
            ...
            <p className="text-orange-100 text-sm mt-1">Enter Verification Code</p>
          </div>
          ...
          <div className="px-8 py-8">
            ...
            <div className="mt-5 text-center">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 text-sm font-semibold text-orange-600 hover:text-orange-800 disabled:text-gray-400 disabled:cursor-not-allowed transition-colors cursor-pointer"
              >
