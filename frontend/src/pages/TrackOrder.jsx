    ...
    <div className="min-h-screen bg-orange-50 px-4 sm:px-6 lg:px-8 py-10">
      <div className="max-w-6xl mx-auto">
          ...
          <div className="p-6 border-b border-gray-100">
            <div className="flex items-center gap-3">
              <div className="w-11 h-11 rounded-xl bg-orange-100 flex items-center justify-center">
                <MapPin size={23} className="text-orange-600" />
              </div>
            ...
            {locationLoading ? (
              ...
              <div className="absolute inset-0 flex items-center justify-center px-6">
                <div className="text-center max-w-md">
                  <MapPin size={42} className="mx-auto mb-3 text-gray-400" />

                  <h3 className="font-bold text-gray-800 mb-2">
                    Location unavailable
                  </h3>

                  <p className="text-sm text-gray-500 mb-5">{locationError}</p>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          ...
          {/* Order items */}
          <div className="bg-white rounded-3xl shadow-sm border border-orange-100 p-6">
            <h2 className="text-xl font-bold text-gray-900 mb-5">Your Items</h2>
