...
function Navbar() {
  ...
  useEffect(() => {
    ...
    const loadUserNotifications = async () => {
      try {
        // Small delay gives the login request time
        // to finish and the notification to be created.
        ...
        // Prevent the same notification from
        // appearing repeatedly during the same session.
          ...
          <div className="bg-white border border-[#ead9cd] rounded-2xl shadow-2xl overflow-hidden">
            <div className="flex items-start gap-3 p-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <Link
                  to={notificationPopup.link || "/notifications"}
                  onClick={() => setNotificationPopup(null)}
              ...
              <li className="relative group">
                ...
                <div className="absolute left-0 top-full pt-3 w-64 hidden group-hover:block z-50">
                  <div className="bg-white border border-[#ead9cd] rounded-xl shadow-xl overflow-hidden">
                    <Link
                      to="/build-snack-box"
                      className="block px-4 py-4 text-gray-700 hover:bg-[#f6eee8] hover:text-[#8b563b]"
                    >
                    ...
                    <Link
                      to="/smart-budget"
                      className="block px-4 py-4 border-t border-gray-100 text-gray-700 hover:bg-[#f6eee8] hover:text-[#8b563b]"
                    >
