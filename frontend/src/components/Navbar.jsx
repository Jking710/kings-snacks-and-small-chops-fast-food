...
return (
<header
className={`relative z-50 w-full border-b border-[#ead9cd] bg-[#f6eee8] transition-all ${header ? "bg-[#fffdfb] py-3 shadow-lg" : "py-5"}`}
>
{notificationPopup && (
          ...
          <>
            <li>
              <Link
                to="/profile"
                onClick={() => setMobileNavOpen(false)}
                className="block rounded-lg px-4 py-2 hover:bg-[#ead9cd] hover:text-[#8b563b]"
              >
                My Profile
              </Link>
            </li>
