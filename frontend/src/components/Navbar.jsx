...
const handleMobileProfileNavigation = (path) => {
setUserMenuOpen(false);
setNotificationOpen(false);
setMobileNavOpen(false);
navigate(path);
...
>
{notificationPopup && ( <div className="fixed right-5 top-5 z-50 w-[min(380px,calc(100vw-32px))]"> <div className="overflow-hidden rounded-2xl border border-[#ead9cd] bg-white shadow-2xl"> <div className="flex items-start gap-3 p-4"> <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#f6eee8] text-[#8b563b]"> <Bell className="h-5 w-5" /> </div>
          ...
          <div ref={userMenuRef} className="relative">
            ...
            {userMenuOpen && (
              <div className="absolute right-0 top-full z-50 mt-2 w-60 rounded-xl border border-[#ead9cd] bg-white py-2 text-left shadow-xl">
                ...
                <button
                  type="button"
                  onClick={() => handleMobileProfileNavigation("/profile")}
                ...
                <button
                  type="button"
                  onClick={() => handleMobileProfileNavigation("/cart")}
                  className="flex w-full cursor-pointer items-center gap-2 px-4 py-3 text-left text-sm text-gray-700 transition-colors hover:bg-[#f6eee8] hover:text-[#8b563b]"
                >
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleMobileProfileNavigation("/order-history")
                  }
                  className={`flex w-full cursor-pointer items-center gap-2 px-4 py-3 text-left text-sm transition-colors ${
